...
import 'package:flutter_waterfall/pay_for.dart';
import 'package:flutter_waterfall/welcome.dart';
    ...
    return Scaffold(
      ...
      children: <Widget>[
        new Container(
          ...
          child: new Image(image: moviePhotos[_pos], fit: BoxFit.cover),
        ),
        new Positioned(
          top: 40,
          left: 25,
        ...
        new Positioned(
          ...
          left: 25,
          child: new Text(
              "Here is the waterfall paradise\nwelcome your arrivalwe have\nprepared a scene for you",
        ...
        new Positioned(
            ...
            child: new Container(
              ...
              child: new ListView(
                ...
                children: <Widget>[
                  listItem("รูปที่ 1", "images/c.jpg"),
                  new SizedBox(width: 30),
                  listItem("รูปที่ 2", "images/a.jpg"),
                  new SizedBox(width: 30),
                  listItem("รูปที่ 3", "images/d.jpg"),
                  new SizedBox(width: 30),
                  listItem("รูปที่ 4", "images/b.jpg"),
                  new SizedBox(width: 30),
                  listItem("รูปที่ 5", "images/f.jpg"),
                  new SizedBox(width: 30),
                  listItem("รูปที่ 6", "images/e.jpg")
                ],
              ),
            )),
        new Positioned(
              ...
              child: new Container(
                ...
                decoration: new BoxDecoration(
                    ...
                    image: new DecorationImage(
                        image: new AssetImage(imgPath), fit: BoxFit.cover)),
              ),
            )),
      ],
    );
...
class _SecondState extends State<Second> {
  void _navigateToPayForScreen(BuildContext context) {
    Navigator.push(
      context,
      MaterialPageRoute(
          builder: (context) =>
              PayForScreen()), // ถ้าหาก PayForScreen เป็นวิดเจ็ตหน้าจอการชำระเงินของคุณ
    );
  }
    ...
    return Scaffold(
      ...
      children: <Widget>[
        ...
        new Positioned(
            ...
            left: 25,
            child: new Text(
              "Located in the middle reaches of the zambezi river\nin Africa, Zambia and Zimbabwe border.",
                ...
                child: new Padding(
                  ...
                  child: new Column(
                    ...
                    children: <Widget>[
                      ...
                      new Row(
                        ...
                        children: <Widget>[
                          new Container(
                            ...
                            decoration: new BoxDecoration(
                                border: Border.all(
                                    color: Color(0xFFf7f8f8), width: 1),
                                boxShadow: [
                                  BoxShadow(
                                    blurRadius: 11.0,
                            ...
                            child: new Column(
                              children: <Widget>[
                                ...
                                new Text("Wide",
                                    style: new TextStyle(
                                        color: Color(0xFFb7bfc1), fontSize: 14),
                                    textAlign: TextAlign.center)
                              ],
                            ),
                          ),
                      ...
                      new SizedBox(height: 15),
                      new Text(
                          "Located on the zambezi river, the waterfall is the lar\ngest waterfall in Africa and one of the largest, most\nbeautiful and spectacular waterfalls in the world.",
                          style: new TextStyle(
                              fontSize: 14,
                              fontWeight: FontWeight.bold,
                              color: Color(0xFF90989a))),
                    ],
                  ),
                ))),
        new Positioned(
      ...
      children: <Widget>[
        ...
        new Container(
          ...
          child: new ElevatedButton(
            onPressed: () {
              _navigateToPayForScreen(context);
            },
            style: ButtonStyle(
              backgroundColor: MaterialStateProperty.all<Color>(Color.fromARGB(255, 255, 1, 1)),
            ),
            child: Text(
              "Pay For",
              style: TextStyle(
